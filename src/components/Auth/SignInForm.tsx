...
export default function SignInForm() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-xs mx-auto absolute top-4 p-3 bg-red-50 rounded-lg border border-red-400 text-red-600 font-medium ${
          errorMessage == "" ? "hidden" : ""
        }`}
      >
        {errorMessage}
      ...
      <input
        ...
        className="w-full max-w-sm mx-auto bg-gray-200 p-3 placeholder:text-gray-600"
      ...
      <div className="w-full max-w-sm mx-auto text-end">
        <Link href="/" className="text-sm text-runss-second-blue-color">
          Forgot password?
        </Link>
      </div>
